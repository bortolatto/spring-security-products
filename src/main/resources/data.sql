...
insert into authority (id, user_id, name) values (nextval('authority_seq'), currval('user_seq'), 'ADMIN');
insert into authority (id, user_id, name) values (nextval('authority_seq'), currval('user_seq'), 'USER');